...
def main(argv=None):
    ...
    parser.add_argument('-d','--debug',action="count",help='Increase the general debug level by one.',default=0)
    parser.add_argument('-rd','--rootdebug',action="count",help='Increase the ROOT debug level by one.',default=0)
    parser.add_argument('-gd','--geomdebug',action="count",help='Increase the Geometry debug level by one.',default=0)
