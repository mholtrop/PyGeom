...
# d for doubles
    ...
    def __init__(self, name, description, identifiers, signalThreshold="0*MeV", timeWindow="10*ns",
                 prodThreshold="0*mm", maxStep="1*mm", riseTime="1*ns", fallTime="1*ns",
                 mvToMeV="1", pedestal="0", delay="0*ns", bankId=0):
    ...
    def identity(self,*indexes):   # The * means, add all the arguments into the list called indexes
        """ Given a tuple of indexes i.e. (1,2,3), return the correct string for the indentity entry in the
        Geometry definition"""
        outstr=""
